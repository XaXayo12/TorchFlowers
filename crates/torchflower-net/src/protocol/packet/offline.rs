...
//! In torchflower-net, these packets consist of:
//! - [`UnconnectedPing`]
//! - [`UnconnectedPong`]
//! - [`OpenConnectRequest`]
//! - [`OpenConnectReply`]
...
///         and the
///         <a
///             href="/torchflower-net/latest/protocol/mcpe/struct.UnconnectedPong.html"
///             title="struct torchflower_net::protocol::mcpe::UnconnectedPing">
///             UnconnectedPong
///         </a>
...
fn write_inverted_addr(addr: &SocketAddr, buf: &mut ByteWriter) -> Result<(), std::io::Error> {
    match addr {
        SocketAddr::V4(addr) => {
            ...
            let inverted: [u8; 4] = [!octets[0], !octets[1], !octets[2], !octets[3]];
            buf.write(&inverted)?;
